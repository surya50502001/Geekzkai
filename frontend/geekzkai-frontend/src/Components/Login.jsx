...
function Login() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-background-primary p-4 absolute inset-0 z-10" style={{ marginLeft: 'var(--sidebar-width, 0px)' }}>
