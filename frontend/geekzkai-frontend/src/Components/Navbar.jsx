    ...
    return (
        <nav className="p-2 flex justify-between items-center text-text-primary relative animated-gradient font-sans">
            ...
            <div className="flex gap-2 items-center text-white">
                ...
                {open && (
                    <div className="absolute h-screen top-full right-0 w-48 flex flex-col items-start py-4 gap-3 text-primary font-semibold shadow-lg rounded-lg border border-border-primary z-50 animate-slideDown">
